...
<div class="container">
    <div class="row">
        ...
        <div class="col-9 pt-5">
            ...
            <div class="pt-3" style="font-weight: bold;">Karishma Karki</div>
            <div>Student of Computer Science and Information Technology.</div>
            <div>www.yantrashala.com</div>
        </div>
    </div>
    <div class="row pt-4">
        <div class="col-4">
